        ...
        <table class="table text-white table-bg">
            <thead>
                <tr>
                    ...
                    <script>function exibeAlert(){alert("Esse email ja foi enviado!!")}</script>
                    <th scope="col"></script><a onclick="exibeAlert()" value="Exibir Alert" class='btn btn-sm btn-primary' href='email.php' title='E-mail'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
