...
<head>
  ...
  <title>Formulários / Elementos</title>
...
<body class="">
      ...
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">
          <font style="vertical-align: inherit;">
            <font style="vertical-align: inherit;">Global Access</font>
          </font>
        </span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php">
          ...
          <span>
            <font style="vertical-align: inherit;">
              <font style="vertical-align: inherit;">Painel</font>
            </font>
          </span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#" aria-expanded="true">
          <i class="bi bi-journal-text"></i><span>
            <font style="vertical-align: inherit;">
              <font style="vertical-align: inherit;">Formulários</font>
            </font>
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.php" class="active">
              <i class="bi bi-circle"></i><span>
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Cadatro de Usuarios</font>
                </font>
              </span>
            </a>
          </li>
          <li>
            <a href="forms-layouts.php">
              <i class="bi bi-circle"></i><span>
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Cadastro de Eventos</font>
                </font>
              </span>
            </a>
          </li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>
        <font style="vertical-align: inherit;">
          <font style="vertical-align: inherit;">Elementos do formulário</font>
        </font>
      </h1>
      <nav>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
                <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">Elementos Gerais do Formulário</font>
                </font>
              </h5>
              ...
              <form action="saveEdit.php" method="POST">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="txt" name='txt' class="form-control" value=<?php echo $txt;?>>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">
                  ...
                  <div class="col-sm-10">
                    <input type="CPF" name='CPF' class="form-control" value=<?php echo $CPF;?>>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="senha" id="senha" name='senha' class="form-control"value=<?php echo $senha;?>>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="radios2">
                        <font style="vertical-align: inherit;">
                          <font style="vertical-align: inherit;">Sexo Feminino</font>
                        </font>
                      </label>
                    </div>
                    <input type="hidden" name="id" class="btn btn-primary" value=<?php echo $id;?>>
                    <input type="submit" value="Salvar" name="update" class="btn btn-primary">
    ...
    <div style="padding: 8px;">
      <div>
        <div class="logo"><img src="https://www.gstatic.com/images/branding/product/1x/translate_24dp.png" width="20"
            height="20" alt="Google Tradutor"></div>
      </div>
    </div>
